import { Syne, Space_Grotesk, Space_Mono, Plus_Jakarta_Sans } from "next/font/google";
...
export default function RootLayout({ children }) {
  return (
    <html
      lang="en"
      className={`${syne.variable} ${spaceGrotesk.variable} ${spaceMono.variable} ${plusJakartaSans.variable} h-full antialiased`}
    >
      <head>
